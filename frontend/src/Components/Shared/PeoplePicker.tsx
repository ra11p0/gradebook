...
import PersonResponse from '../../ApiClient/Schools/Definitions/PersonResponse';
...
function PeoplePicker(props: Props) {
    ...
    useEffect(() => { setSelectedPeople([]) }, [props.show]);
    return (
                    ...
                    <InfiniteScrollWrapper
                        ...
                        mapper={(person: PersonResponse, index) => (
                            <div
                                ...
                                onClick={() => {
                                    selectedPeople.includes(person.guid) ? setSelectedPeople(s => s.filter(p => p != person.guid)) : setSelectedPeople(s => [...s, person.guid])
                                }}>
                                ...
                                <div>
                                    <Checkbox
                                        ...
                                        onChange={(e, o) => o ? setSelectedPeople(s => [...s, person.guid]) : setSelectedPeople(s => s.filter(p => p != person.guid))}
                                    />
                                </div>
                            </div>
                        )}

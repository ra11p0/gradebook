...
const RegisterAdministratorSchool = (
  props: RegisterAdministratorSchoolProps,
): ReactElement => {
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <div className="m-1 p-1 d-flex justify-content-end">
        <Button variant="link" onClick={props.onContinueWithoutSchool}>
          {t('continueWithoutNewSchool')}
        </Button>

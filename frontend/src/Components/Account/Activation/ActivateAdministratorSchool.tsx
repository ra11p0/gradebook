...
const ActivateAdministratorSchool = (
  props: ActivateAdministratorSchoolProps
): ReactElement => {
  const { t } = useTranslation('ActivateAdministratorSchool');

  const validate = (values: ActivateAdministratorSchoolValues): any => {
    const errors: any = {};
...
export default ActivateAdministratorSchool;
